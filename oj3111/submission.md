...
```text
โจทย์ต้องการให้คำนวณหาราคาสุทธิที่ต้องจ่ายหลังจากคิดราคาสมาชิกหรือราคาก่อนลดตามเงื่อนไข โดยปัดเศษเป็นทศนิยม 2 ตำแหน่ง

Input:
เป็นตัวย่อ Y หรือ N เพื่อดูว่าเป็นสมาชิกไหม
และอีกบรรทัดคือจำนวนสินค้าที่ซื้อ เพื่อรู้จำนวนที่ต้องรับค่าสินค้าแต่ละอย่าง

Output:
ยอดสุทธิที่ต้องจ่ายหลังคำนวณเป็นทศนิยม 2 ตำแหน่ง
...
```text
Step 1: อ่านโจทย์อย่างละเอียด
Step 2: สร้างตัวแปรรับค่าอักษรและจำนวนสินค้าเป็นตัวเลข
Step 3: สร้างตัวแปรtotalเป็นDecimal
Step 4: ใช้loopรับค่าสินค้า
Step 5: ใช้ if-else เช็คว่าเป็นสมาชิกหรือยอดก่อนลดมากกว่าเท่ากับ 500 แล้วเข้าเงื่อนไข
Step 6: แสดงผลราคาสุทธิแบบปัดเศษ โดยเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
เหมือนกัน เพราะเป็นวิธีที่เข้าใจง่ายและตรงกับที่โจทย์ต้องการ
```
...
```text
เพราะเป็นสมาชิกและตัวเลขมีทศนิยม
```
...
```text
เพราะเป็นสมาชิกและตัวเลขเป็นจำนวนเต็ม
```
...
```text
เพราะไม่เป็นสมาชิกแต่ยอดเกิน 500
```
