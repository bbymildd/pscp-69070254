...
```text
โจทย์ต้องการให้เช็คว่าเวลาที่กำหนดนี้อยู่ในช่วงเวลาที่มีกี่ร้านเปิดบ้าง

Input:
จำนวนร้านและช่วงเวลาที่ต้องการเช็ค รวมถึงช่วงเวลาที่แต่ละร้านเปิดปิด

Output:
จำนวนร้านที่เปิดในแต่ละเวลาที่กำหนด
...
Step 2: สร้างตัวแปรรับค่าและloopรับช่วงเวลาเปิด-ปิด
Step 3: สร้างตัวแปร diff กำหนดไว้ 1442 เพราะคิดนาทีที่ร้านปิดด้วยและloop
Step 4: สร้างตัวแปร opened เพื่อเก็บจำนวนร้านที่เปิดและloop
...
```text
เหมือนกัน เพราะเป็นวิธีที่ไม่ยาวและเข้าใจง่าย
```
...
```text
เพราะเป็นกรณีที่ร้านเปิดทั้งหมด
```
