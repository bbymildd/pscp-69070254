...
```text
โจทย์ให้มา3สีหลักและมีอีก3สีที่เกิดจากผสมสีหลักเป็นคู่ๆแต่ถ้ามีสีอื่นนอกจากสีหลักถือว่าerror

Input:
กำหนดสองตัวแปรเพื่อรับข้อมูลสีหลัก

Output:
พิมพ์สีที่ได้จากการผสมสีหลัก2สี

Constraints:
การพิมพ์ชื่อสีสามารถพิมพ์ได้แต่ขึ้นต้นตัวพิมพ์ใหญ่ตามด้วยพิมพ์เล็ก
```
---
...
```text
Step 1:กำหนด2ตัวแปรรับชื่อสี
Step 2:ใช้if elseกำหนดเงื่อนไขสีหลักที่ผสมและพิมพ์สีที่ผสมได้
Step 3:พิมพ์สีที่ได้จากการผสม
```
...
```text
เหมือนกัน เพราะคิดว่าเป็นวิธีที่ครอบคลุมทุกtest case
```
...
```text
ให้ hint test cases ที่ยังไม่ครอบคลุม
```
