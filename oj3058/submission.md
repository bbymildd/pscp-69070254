...
```text
โจทย์ให้คิดจากจำนวนก้อนหินเล็กมีค่า 1 และก้อนใหญ่มีค่า 5
ที่รับเข้ามาว่าพอกับค่าgoalที่รับเข้ามาไหม โดยการคิดต้องเริ่มจากดูก้อนใหญ่ก่อนแล้วค่อยคิดก้อนเล็ก

Input:
รับค่าจำนวนก้อนหินเล็ก ก้อนหินใหญ่และค่าgoalที่ต้องการ

Output:
ถ้าสร้างได้ให้แสดงค่าก้อนหินเล็กที่ใช้ แต่ถ้าสร้างไม่ได้ให้แสดงค่า -1

Constraints:
รับค่าได้แค่จำนวนเต็ม
```
...
Step 2: กำหนดตัวแปรรับค่า 3 ตัว
Step 3: คิดก้อนใหญ่ที่จะใช้ได้มากสุดก่อน
Step 4: ใช้จำนวนทั้งหมด - ก้อนใหญ่ที่ใช้ เพื่อให้ได้จำนวนก้อนเล็ก
```
...
```text
เหมือนกัน เพราะเป็นวิธีที่เข้าใจง่ายและครอบคลุมตามโจทย์
```
...
```text
เป็นกรณีความยาวที่ต้องการเท่ากับความยาวก้อนหินท่มีรวมกัน
```
...
```text
เป็นกรณีที่ก้อนหินใหญ่เพียงอย่างเดียวก็เพียงพอ
```
...
```text
เพราะเป็นกรณีที่ก้อนหินไม่พอสร้าง
```
