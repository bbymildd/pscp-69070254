...
```text
โจทย์ต้องการรับค่าสี RGB มา 2 สีแล้วคำควณผสม 2 สีนั้นแล้วเกิดสีใหม่

Input:
ค่า R G B ของ 2 สีคนละบรรทัด
...
```text
Step 1: อ่้านโจทย์อย่างละเอียด
Step 2: กำหนดฟังก์ชั่นรับค่าแปลงเป็นlist
Step 3: กำหนดฟังก์ชั่นหาค่าเฉลี่ยแต่ละคู่ ใช้ return เรียกค่ากลับ
```
...
```text
เหมือนกัน เพราะเข้าใจง่ายเป็นระเบียบทีละขั้นตอน
```
