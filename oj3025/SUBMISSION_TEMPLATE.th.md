...
```text
โจทย์หลักๆคือมี12เดือน4ฤดู ให้แยก3เดือนต่อ1ฤดู ถ้าเป็นเดือนที่หาร3ลงตัววันที่21เป็นต้นไปของเดือนๆนั้นจะถือว่าเป็นฤดูถัดไปแล้ว

Input:
2ตัวแปรรับค่าเดือนและวันที่

Output:
ถ้าเป็นเดือนที่หาร3ไม่ลงตัวและเดือนที่หาร3ลงตัวจะแสดงค่าฤดูในช่วงนั้นๆปกติ แต่ถ้าเดือนที่หาร3ลงตัวแล้ววันที่21ขึ้นไปจะถือว่าเป็นช่วงของฤดูถัดไป

Constraints:
ถ้าใส่เดือนมากกว่า12จะไม่เข้าเงื่อนไขใดที่จะแสดงผลออกมาเลย
```
...
```text
Step 1: อ่านโจทย์ต้องมี2ตัวแปรรับค่าเดือนกับวันที่
Step 2: ดูเงื่อนไขยิบย่อยที่มีผลกับตอนแสดงค่า
Step 3: เห็นว่าทุกเดือนที่3ของแต่ละฤดูจะมีเงื่อนไขเพิ่มเติม
Step 4: ลองเขียนตามความเข้าใจ
```
...
```text
เหมือนกัน เพราะที่ลองเขียนเข้าใจง่ายและตรงกับที่โจทย์ต้องการ
```
...
```text
เพราะเป็นเดือนที่หาร3ลงตัวแต่วันที่ยังไม่ถึง21
```
...
```text
เพราะเป็นเดือนที่หาร3ลงตัวและวันที่เกิน21
```
