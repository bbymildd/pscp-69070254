...
```text
โจทย์ต้องการหาว่ากบต้องกระโดดกี่ครั้งถึงจะถึงระยะเป้าหมาย ซึ่งระยะที่โดดได้จะลดทีละ2จากครั้งแรก จึงมีโอกาสโดดเกิน,โดดถึง,โดดไม่ถึง

Input:
ระยะที่โดดครั้งแรกและระยะที่ต้องการไปให้ถึง

Output:
จำนวนครั้งอย่างน้อยที่ใช้ในการกระโดดให้ถึงหรือถ้ากระโดดไม่ถึงแสดงค่า -1
```
...
Step 2: กำหนดตัวแปรรับระยะเริ่มและระยะจบ
Step 3: กำหนดตัวแปร = 0 เอาไว้นับเพิ่มหรือลดใช้ใน while loop
Step 4: ใช้ if-else ทำกรณีถ้าระยะรวมเกินกว่าที่ต้องการให้breakแสดงค่าจำนวนครั้งเลยและถ้าไม่ถึงให้แสดง -1
```
...
```text
เหมือนกัน เพราะคิดว่าข้อนี้ควรใช้วิธีนี้ถึงจะครอบคลุม
```
...
```text
เพราะเป็นกรณีที่ไปถึงระยะที่ต้องการ
```
...
```text
เพราะเป็นกรณีที่ถึงเป้าหมายก่อนหยุดโดด
```
...
```text
เพราะเป็นกรณีโดดไปไม่ถึงเป้าหมาย
```
