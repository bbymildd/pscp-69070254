...
```text
โจทย์ให้รับค่าอูณหภูมิและรับตัวอักษรเพื่อระบุหน่วยอุณหภูมิที่รับเข้ามาตอนแรกและรับอีกค่าตัวอักษรคือหน่วยที่ต้องการ จากนั้นเข้าตามสูตรที่โจทย์มีให้เพื่อเปลี่ยนหน่วยและแสดงค่าอูณหภูมิทศนิยม 2 ตำแหน่ง

Input:
มีการรับค่า3ตัวแปรคือรับค่าอูณหภูมิ รับตัวอักษรหน่วยอูณหภูมิและรับตัวอักษรหน่วยที่ต้องการ

Output:
แสดงค่าอูณหภูมิตามหน่วยที่ต้องการ

Constraints:
ต้องพิมพ์ตัวย่อหน่วยอูณหภูมิเป็นตัวพิมพ์ใหญ่ตามที่กำหนดในเงื่อนไขเท่านั้น หากเป็นพิมพ์เล็กจะแสดงค่าไม่ถูกต้อง
```
...
```text
Step 1: อ่านโจทย์ให้เข้าใจและสร้างตัวแปรรับค่า
Step 2: สร้างตัวแปรหน่วยอูณหภูมิต่างๆตามสูตรที่โจทย์ให้
Step 3: สร้างเงื่อนไข if-else
Step 4: ลองรันและปรับแก้ไปเรื่อยๆ
```
...
```text
ต่างกัน เพราะในแผนแรกสร้างตัวแปรสูตรของหน่วยอูณหภูมิซ้ำซ้อนและรันไม่ผ่าน แต่ในแผนสุดท้ายปรับมาใช้if-elseเลย แล้วเอาสูตรไปใส่ในเงื่อนไขแยกกันเพื่อให้ทุกกรณีเปลี่ยนเป็น Celsius ก่อนแปลง
```
...
```text
เพราะแปลงค่าจาก Celsius ไป Farenheit
```
...
```text
เพราะแปลงค่าจาก Kelvin ไป Rankine 
```
