...
```text
โจทย์ให้หาแถบที่ตัวเลข N ถูกปลูกอยู่ ซึ่งคิดจากการนับช่องทีละ L ช่องและทแยงขึ้นไป

Input:
รับค่า L ช่องและช่องที่ N
...
Step 2: กำหนดตัวแปรรับค่า L และ N
Step 3: ใช้ while loop จนกว่าจะเข้าใกล้ตำแหน่ง N
```
...
```text
เพราะถ้า L = 1 N นี้จะเป็นช่องสุดท้ายของแถบที่ 4
```
