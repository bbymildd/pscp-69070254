...
```text
โจทย์ต้องการให้ตรวจว่าที่อักษรและเลขที่ซื้อตรงกับรางวัลไหม ซึ่งจะมีหลายรางวัลตามตำแหน่งที่ซ์ื้อถูก
...
Step 2: กำหนดตัวแปรรับปลสากกับสลากที่ซื้อ
Step 3: ใช้if-elseและslicingตรวจรางวัล
```
...
```text
เหมือนกัน เพราะเป็นวิธีที่ตรงตัวและเข้าใจง่าย
```
...
```text
เพราะเป็นกรณีถูกเลขท้าย 3 ตัวและอักษร
```
...
```text
เพราะเป็นกรณีถูกเลขท้าย 3 ตัวอย่างเดียว
```
