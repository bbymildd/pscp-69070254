...
```text
โจทย์ต้องการให้รับค่ามา 5 ข้อความและให้มี * เป็นกรอบล้อมรอบโดยยึดความยาวข้อความที่ยาวที่สุด

Input:
ข้อความ 5 บรรทัด

Output:
ข้อความ 5 บรรทัดที่มีกรอบ * ล้อมรอบ
```
...
Step 2: สร้างตัวแปรรับข้อความ 5 บรรทัด
Step 3: เปรียบเทียบแต่ละข้อความหาข้อมความที่ยาวสุด
Step 4: แสดงผลสร้างกรอบ * รอบข้อความ
```
...
```text
เหมือนกัน เพราะเป็นวิธีที่เข้าใจง่ายและครอบคลุม
```
