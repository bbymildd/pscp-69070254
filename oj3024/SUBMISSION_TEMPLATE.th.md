...
```text
โจทย์คือมีทั้งหมด3คนให้คะแนน0-10 รับค่าเข้าเป็นผลรวมกับแค่คะแนนของคนที่ให้มากสุุด ถ้าคะแนนสูงสุดคะแนนมากกว่าคนที่ให้ต่ำสุดมากกว่า2จะแสดง"Surprising"แต่ถ้าห่างไม่เกินจะแสดง"Not surprising"

Input:
รับค่าคะแนนรวมและค่าคะแนนมากที่สุด

Output:
ถ้าคะแนนห่างกันมากกว่า2จะแสดง"Surprising"แต่ถ้าห่างไม่เกินจะแสดง"Not surprising"

Constraints:
ไม่สามารถครอบคลุมได้ทุกกรณี ดูได้แค่มีโอกาสไหม
```
...
```text
Step 1: อ่านโจทย์ทำความเข้าใจ
Step 2: สร้างตัวแปรรับค่าผลรวมกับคะแนนสูงสุด
Step 3: สร้างเงื่อนไขให้สอดคล้องกับโจทย์
...
```text
เหมือนกัน เพราะทำทีละขั้นตอนที่เข้าใจและปรับแก้ไปเรื่อยๆจนผ่าน
```
...
```text
เพราะเป็นจำนวนจริงน้อยกว่า 2 และมีทศนิยม
```
...
```text
เพราะเป็นจำนวนที่มีโอกาสห่างกันเกิน 2
```
...
```text
เพราะเป็นจำนวนที่มากกว่า 2 และมีทศนิยม
```
