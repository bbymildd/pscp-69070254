...
```text
โจทย์ให้รับจำนวนตัวเลขเข้ามาและรับสัญลักษณ์เข้าตามจำนวนนั้น ซึ่งถ้าเป็น + เพิ่ม 10 ถ้าเป็น - ลดลง 5 แสดงผลเป็นผลรวมหลังจากคำนวณตามสัญลักษณ์ทั้งหมด

Input:
รับตัวเลขจำนวนที่จะให้รับสัญลักษณ์เข้ามา

Output:
แสดงค่าผลรวมหลังจากคิดสัญลักษณ์ทั้งหมด

Constraints:
สัญลักษณ์ที่รับเข้ามาคิดได้แค่เฉพาะ + และ - เท่านั้น
```
...
```text
Step 1: อ่านโจทย์ให้ละเอียดและทำความเข้าใจ
Step 2: คิดว่าต้องมีการรับค่าตัวเลขก่อน และค่าloopรับสัญลักษณ์ตามจำนวนตัวเลข
Step 3: สร้าง if-else ตรวจว่าเป็นสัญลักษณ์ไหน เพื่อที่จะคำนวณได้ถูกต้อง
Step 4: แสดงผลรวมจากการคำนวณ
```
...
```text
เหมือนกัน เพราะเป็นวิธีที่ไม่ซับซ้อนและเขียนสั้น ได้ผลลัพธ์ตามโจทย์ต้องการ
```
