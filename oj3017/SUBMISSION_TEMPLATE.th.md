...
```โจทย์ให้คิดรวมค่าใช้จ่ายทั้งหมด ซึ่งกำหนดค่าบริการ 10%(ขั้นต่ำ50บาทและมากสุด1000บาท)และVAT 7%

Input:
กำหนดหนึ่งตัวแปรที่คิดแค่ค่าอาหาร

Output:
พิมพ์ค่าอาหารรวมค่าบริการและVATมีทศนิยม2ตำแหน่ง

Constraints:
ตัวแปรรับค่าอาหารแค่แบบจำนวนเต็ม
---
...
```text
Step 1:ตัวแปรรับค่าอาหาร
Step 2:ใช้if elif 3กรณียึดตามช่วงของค่าบริการ
Step 3:พิมพ์ค่าอาหารที่Netแล้ว
```
...
```เหมือนกัน เพราะif elif 3กรณีของค่าบริการครอบคลุมแล้ว
...
```ค่าอาหารน้อยกว่าขั้นต่ำค่าบริการ
...
```ค่าอาหารอยู่ในช่วงคิดค่าบริการปกติ
...
```ค่าอาหารเลยช่วงคิดค่าบริการตามจริง
