...
```text
โจทย์ต้องการให้รับค่าตัวเลขห้องที่อยู่แล้วแสดงค่าวิธีที่จะกลับไปห้องที่1โดยผ่านห้องให้น้อยที่สุด โดยจากตัวอย่างวิธีที่ควรใช้คือผ่านชั้นละ 2 ห้องจากชั้นที่ห้องนั้นอยู่ แต่ถ้าเลขห้องที่เป็นตำแหน่งเลขคู่ในชั้นนั้นคิดแค่ผ่าน 1 ห้องสำหรับชั้นนั้นพอ

Input:
รับค่าเลขห้อง

Output:
จำนวนห้องที่น้อยที่สุดหากจะไปห้อง 1 ต้องผ่าน

Constraints:
ไม่สามารถคำนวณกรณีจำนวนติดลบ
```
...
```text
Step 1: อ่านโจทย์และทำความเข้าใจ
Step 2: สร้างตัวแปรรับค่าเลขห้องที่อยู่
Step 3: สร้าง while loop หาว่าห้องนั้นอยู่ชั้นไหน
Step 4: สร้างตัวแปรหาห้องแรกที่อยู่ชั้นนั้นและหาตำแหน่งห้องที่อยู่
Step 5: ใช้ifเพื่อเช็คว่าตำแหน่งห้องเป็นเลขคู่มั้ย
Step 6: แสดงผล
```
...
```text
เหมือนกัน เพราะที่คิดไว้สามารถแสดงผลได้ตามที่โจทย์ต้องการ
```
...
```text
เพราะลองว่าถ้าเป็นห้อง1ที่อยู่ชั้น1
```
...
```text
เพราะลองว่าถ้าเป้นห้องที่ตำแหน่งเลขคู่ในชั้น
```
...
```text
เพราะลองห้องที่ตำแหน่งในชั้นเป็นเลขคี่
```
