...
```text
โจทย์ต้องการให้รับค่าจำนวนที่เริ่มและจบ เพื่อจะตรวจเลขที่อยู่ในช่วงนั้นว่ามีจำนวนเฉพาะไหม และมีทั้งหมดกี่ตัว

Input:
ตัวเลขที่จะเริ่มคิดและเลขที่สิ้นสุด

Output:
แสดงเลขจำนวนเฉพาะที่อยู่ในช่วงนั้น และแสดงจำนวนของจำนวนเฉพาะทั้งหมดในช่วง
```
...
Step 2: สร้างตัวแปรมารับค่าช่วงของเลขที่ต้องการคิด
Step 3: ใช้ while loopคิดจนกว่าค่าstart=stop
Step 4: ใช้ if เข้ามาตรวจและใช้ True/False
Step 5: ใช้ append เก็บจำนวนเฉพาะเข้า list รอแสดงผล
```
...
```text
เหมือนกัน เพราะสามารถตรวจหาจำนวนเฉพาะได้ครอบคลุม
```
...
```text
เพราะต้องการดูว่าสามารถตรวจจนถึงเลขสุดท้ายของช่วงไหม
```
...
```text
เพราะเป็นช่วงที่ไม่มีจำนวนเฉพาะ
```
