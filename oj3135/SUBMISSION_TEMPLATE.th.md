...
```text
โจทย์ต้องการหาขโมยโดยตรวจแบบเป็นวงกลม ถ้าวนแล้วกลับมาคนแรกให้หยุดเลย ส่วนถ้าวนแล้วหยุดที่โจรก็นับรวมโจรแล้วหยุด

Input:
จำนวนคน ส่งของขวัญให้คนถัดไป เลขของโจร

Output:
จำนวนคนที่ได้ดูของขวัญ
```
...
Step 2: กำหนดตัวแปรรับค่า
Step 3: สร้างloopและเงื่อนไขเพื่อวนตรวจสอบ
```
...
```text
เหมือนกัน เพราะเป็นวิธีที่สั้นและเข้าใจง่าย
```
