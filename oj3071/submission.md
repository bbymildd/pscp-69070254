...
```text
โจทย์ให้คิดว่ามีตัวเลขอะไรบ้างตั้งแต่ค่าของตัวรับแรกไปจนถึงค่าของตัวสุดท้ายที่หารด้วย d ได้เศษ r แล้วนับจำนวน

Input:
รับค่ามาทั้งหมด 4 ตัวคือ 1.ตัวแรกที่นับ 2.ตัวสุดท้ายที่นับ 3.ตัวหาร 4.เศษที่ได้จากการหารด้วยตัวหาร

Output:
จำนวนทั้งหมดที่อยู่ในช่วง แล้วหารด้วย d ได้เศษ r

Constraints:
รับค่าได้แค่แบบจำนวนเต็ม
```
...
Step 2: กำหนดตัวแปรรับค่า 4 ตัว
Step 3: กำหนด count = 0 เพื่อให้ while loop นับค่าเพิ่มเข้ามาที่ละ 1 หากตรงกับเงื่อนไขหารด้วย d เศษ r
Step 4: แสดงจำนวนทั้งหมดที่เป็นไปตามเงื่อนไข
```
...
```text
เหมือน เพราะคิดว่าถ้าใช้ loop แล้วเช็คเงื่อนไขจะทำให้โค้ดสั้นและเข้าใจง่าย
```
