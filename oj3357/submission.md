...
```text
โจทย์ต้องการให้นับจำนวนยีราฟที่สูงกว่าฝั่งซ้ายและขวา

Input:
รับค่าจำนวนยีราฟ และloopรับความสูงยีราฟแต่ละตัว

Output:
จำนวนยีราฟที่สูงกว่าด้สนซ้ายและขวา หรือถ้าเป้นตัวแรกให้ดูแค่ด้านขวา ถ้าเป็นตัวท้ายให้ดูแค่ด้านซ้าย
```
...
Step 2: กำหนดตัวแปรรับจำนวนและ loop รับความสูง
Step 3: ใช้ loop เปรียบเทียบความสูงแต่ละตำแหน่ง
Step 4: ถ้าสูงตามเงื่อนไขให้นับและแสดงผลจำนวนที่นับได้
```
...
```text
เหมือนกัน เพราะเป็นวิธีที่เข้าใจง่ายและตรงตัวตามโจทย์
```
...
```text
เพราะมีแค่ตัวแรกที่สูงกว่าข้างขวา
```
...
```text
เพราะมีตัวอื่นและตัวท้ายที่สูง
```
