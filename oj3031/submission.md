...
```text
โจทย์ให้รับค่าพื้นที่วงกลมที่หมึกขยายและจำนวนคน ซึ่งจำนวนคนส่งผลต่อการรับค่าพิกัดว่าจะมีทั้งหมดกี่พิกัดและแสดงผลเป็นวินาทีที่หมึกท่วมแบบปัดเลขขึ้นเป็นจำนวนเต็ม

Input:
รับค่าพื้นที่หมึกต่อวินาที จำนวนคนและพิกัดแต่ละคน
...
Step 2: สร้างตัวแปรโดยใช้ .split
Step 3: ใช้while loopรับค่าพิกัด
Step 4: ใช้สูตรพื้นที่วงกลม
Step 5: แสดงผล
```
