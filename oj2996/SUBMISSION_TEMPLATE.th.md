...
Constraints:
การใช้[start:stop:step]ต้องใช้กับข้อมูลที่เป็นstringหรือข้อมูลที่เป็นลำดับ จะไม่สามารถใช้กับintโดยตรงได้
---
...
```เหมือนกัน เพราะโจทย์เกี่ยวกับstrและลำดับอักษรวิธีนี้น่าจะดีที่สุด
