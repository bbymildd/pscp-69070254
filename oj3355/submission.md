...
```text
โจทย์ต้องการให้รับเลขมาเรื่อยๆจนกว่าจะเจอเลข -1 จะหยุด แล้วเรียงเลข ถ้าเลขที่รับมามีค่าอยู่ติดกันให้ แสดงค่าออกมาเป็นช่วง ถ้ามีค่าไม่ติดกันให้คั่นด้วย ,

Input:
จำนวนเต็มเรื่อยๆขนกว่าจะเจอ -1

Output:
เรียงเลขที่รับมา หากเป็นเลขที่มีค่าติดกันให้เขียนเป็นช่วง
```
...
Step 2: สร้างตัวแปรไว้เก็บค่าใน list
Step 3: ใช้ while loop รับค่าจนกว่าจะเจอ -1
Step 4: เช็คว่าใน list มีค่ามั้ย
Step 5: เรียงค่าที่รับเข้ามา
Step 6: ใช้ for loop เช็คแต่ละค่าใน list 
```
...
```text
เหมือนกัน เพราะเป็นวิธีที่เข้าใจง่าย ตรงตามที่เข้าใจโจทย์
```
...
```text
เพราะมีทั้งค่าติดกันและไม่ติดกัน
```
